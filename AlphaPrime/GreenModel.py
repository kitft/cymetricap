...
class GreenModel(FSModel):
    ...
    def call(self, input_tensor, j_elim=None):
        ...
        nn_prediction=self.model(input_tensor,training=False)
...
def prepare_dataset_Green(point_gen, data, dirname, special_point,metricModel,BASIS,val_split=0.1, ltails=0, rtails=0, normalize_to_vol_j=True,batch_size=100):
    ...
    special_pullback_train=point_gen.pullbacks(special_points_train)
    special_pullback_val=point_gen.pullbacks(special_points_val)

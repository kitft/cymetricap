...
class bihom_function_generator(tf.Module):
    ...
    def __call__(self, points):
        ...
        for i in range(self.n_projective):
            ...
            tf.debugging.print_v2("kappas:", kappas)
            tf.debugging.print_v2("kappas shape:", tf.shape(kappas))
            tf.debugging.print_v2("kappas dtype:", kappas.dtype)
            tf.debugging.print_v2("cpoints:", cpoints)
            tf.debugging.print_v2("cpoints shape:", tf.shape(cpoints))
            tf.debugging.print_v2("cpoints dtype:", cpoints.dtype)
            tf.debugging.print_v2("points:", points)
            tf.debugging.print_v2("points shape:", tf.shape(points))
            tf.debugging.print_v2("points dtype:", points.dtype)
            tf.debugging.print_v2("i:", i)
            tf.debugging.print_v2("s:", s)
            tf.debugging.print_v2("e:", e)
            tf.debugging.print_v2("kmoduli[i]:", self.kmoduli[i])
            tf.debugging.print_v2("k_fs:", k_fs)
            tf.debugging.print_v2("kappas_prod:", kappas_prod)
            tf.debugging.print_v2("--------------------")
            kappas_prod *= kappas
